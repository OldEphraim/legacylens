...
## Technical Stack (Recommended Path)
...
**Deadline: Wednesday midnight CT (G4) / Sunday 10:59 PM CT (GFA)**
...
A simple RAG pipeline with accurate, relevant retrieval beats a complex system that returns garbage. Interviews are required for Austin admission.
